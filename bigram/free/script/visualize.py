...
selected_words = ['flood_c','damage_e','kill_c','guilty_e','suicide_c','death_e','sleep_c','dream_e','run_c','sun_e','pen_c','happy_e','desk_c','fun_e','pen_c','sleep_e']
